...
final class ServiceIndicatorOptions extends QueryOptions
{
    ...
    public static function fromRequest(Request $request): static
    {
        ...
        /** @var string $orderBy */
        $orderBy = $request->input('orderBy', 'tocName');
        ...
        return new ServiceIndicatorOptions($pageNumber, $perPage, $sorter, $orderBy);
    }
}
