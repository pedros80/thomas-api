...
abstract class BaseIncidentCommandHandler extends CommandHandlerScenarioTestCase
{
    protected Body $body;
    ...
    protected function makeIncidentWasAdded(): IncidentWasAdded
    {
    ...
    protected function makeIncidentWasUpdated(): IncidentWasUpdated
    {
